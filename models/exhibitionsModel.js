/*ملف نموذج المعارض (exhibitionsModel.js)
----------------------------------
وظيفة الملف:
- يحدد نموذج "المعارض" باستخدام Sequelize ORM
- يمثل جدول المعارض في قاعدة البيانات
...
// تعريف نموذج المعارض باستخدام Sequelize
